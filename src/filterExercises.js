...
export const getStudentsInCohort = (cohortNumber) => {
    return students.filter(student => {return student.cohort === cohortNumber})
}
...
export const getFullTimeStudents = () => {
    return students.filter(student => {return student.fullTime === true})
}
...
export const getStudentsByInstructorId = (instructorId) => {
    return students.filter(student => {return student.instructorId === instructorId})
}
...
export const getPolyglotStudents = (languageCount) => {
    return students.filter(student => {return student.languages.length >= languageCount})
}
...
export const getAvailableInstructors = () => {
    const instructorIds = students.map(student => {return student.instructorId})
